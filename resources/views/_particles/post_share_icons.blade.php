...
<div class="content-share">
    ...
    <a class="content-share__item pinterest buzz-share-button" data-share-type="pinterest" data-type="news" data-id="{{ $post->id }}"data-post-url="/shared" data-title="{{ $post->title }}" data-sef="{{ generate_post_url($post) }}">
