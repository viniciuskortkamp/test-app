    ...
    <div class="col-sm-12  col-md-8 col-lg-6">
        ...
        <div class="panel panel-danger">
            ...
            <div class="panel-body form-horizontal">
                ...
                <textarea name="headcode" style="height:120px"
                    class="form-control">{!!   rawurldecode(get_buzzy_config('headcode')) !!}</textarea>
                <span class="help-block">{{ trans('admin.HeadCodehelp') }}</span>
                <br>
                <legend>{{ trans('admin.Footercode') }}</legend>
                <textarea name="footercode" style="height:120px"
                    class="form-control">{!!    rawurldecode(get_buzzy_config('footercode')) !!}</textarea>
