                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="facebookappsecret" name="facebookappsecret"
                            value="{{  auth()->user()->email == 'demo@admin.com' ?  "-YOU DON'T HAVE PERMISSION TO SEE THAT-" : get_buzzy_config('facebookappsecret')  }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="googleappsecret" name="googleappsecret"
                            value="{{  auth()->user()->email == 'demo@admin.com' ?  "-YOU DON'T HAVE PERMISSION TO SEE THAT-" : get_buzzy_config('googleappsecret')  }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="twitterappsecret" name="twitterappsecret"
                            value="{{  auth()->user()->email == 'demo@admin.com' ?  "-YOU DON'T HAVE PERMISSION TO SEE THAT-" : get_buzzy_config('twitterappsecret')  }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="VKONTAKTE_SECRET" name="VKONTAKTE_SECRET"
                            value="{{  auth()->user()->email == 'demo@admin.com' ?  "-YOU DON'T HAVE PERMISSION TO SEE THAT-" : get_buzzy_config('VKONTAKTE_SECRET')  }}">
