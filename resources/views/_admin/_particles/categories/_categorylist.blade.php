@php($subcategories =\App\Categories::byType($altcategories->id)->get())
...
<table class="table table-striped">
    <tbody>
        ...
        <tr style="background-color: #fff;">
            ...
            <td>
                <a href="categories?edit={{ $cat->id }}" class="btn btn-sm btn-success" role="button"
        ...
        <tr style="background-color: #f6f6f6;">
            ...
            <td>
                <a href="categories?edit={{ $catq->id }}" class="btn btn-sm btn-success" role="button"
                    data-toggle="tooltip" title="" data-original-title="{{ trans("admin.edit") }}"><i
                        class="fa fa-edit"></i></a>
