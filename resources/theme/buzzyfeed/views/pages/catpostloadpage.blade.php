            ...
            <div class="content-timeline__media" style="width: 240px; height: 150px;">
                <figure class="content-timeline__media__image">
                    <a href="{{ generate_post_url($item) }}" title="{!! $item->title  !!}">
                        <img data-src="{{ makepreview($item->thumb, 's', 'posts') }}" class="lazyed"
                            alt="{!! $item->title  !!}" width="262" height="147"
                            src="{{ makepreview($item->thumb, 's', 'posts') }}" style="display: inline;">
                    </a>
                </figure>
            </div>
                ...
                <div class="content-timeline__detail__container">
                    ...
                    <div class="content-timeline__detail--bottom">
                        ...
                        <a class="content-timeline__detail__author hide-phone"
                            href="{{ action('UsersController@index', [$item->user->username_slug]) }}"
